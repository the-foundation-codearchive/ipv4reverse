...
for octet_three in 0 $(seq 1 254);do 
            ...
            [[ $(sudo netstat -puteen 2>/dev/null  |wc -l ) -ge 2048 ]]    && (sleep 13  ;  echo "GEN_throttled 13s s FOR ${octet_one}.${octet_two}.${octet_three} CONNs: "$(sudo netstat -puteen 2>/dev/null  |wc -l ) >&2 )
