...
#     )
     (  
         ...
         proxychains python3 /tmp/mydoh.py ${octet_one} ${octet_two} ${octet_three} 2>&1 |grep -v -e ERROR_1 -e ProxyChains -e proxychains -e DeprecationWarning  -e get_event_loop
